...
static unsigned int convert_color(unsigned int src_color, image_format_t dst_fmt)
{
    ...
    {
        /* RRRRR GGGGGG BBBBB → uint16_t, 小端低字节在前 */
        unsigned short rgb565 = ((r & 0xF8) << 8)
                              | ((g & 0xFC) << 3)
                              | ((b & 0xF8) >> 3);
        p_dst_color[0] = (unsigned char)(rgb565 & 0xFF);
        p_dst_color[1] = (unsigned char)((rgb565 >> 8) & 0xFF);
        break;
    }
    ...
    case IMAGE_FORMAT_RGBA8888:
        /* ARGB8888 字节序: byte0=B, byte1=G, byte2=R, byte3=A */
        p_dst_color[0] = b;
        p_dst_color[1] = g;
        p_dst_color[2] = r;
        p_dst_color[3] = a;
                      ...
                      int thickness)
{
    ...
    {
    case IMAGE_FORMAT_RGB565:
        draw_rectangle_c2(pixels, w, h, rx, ry, rw, rh, draw_color, thickness);
        break;
    case IMAGE_FORMAT_RGB888:
                 ...
                 int thickness)
{
    ...
    {
    case IMAGE_FORMAT_RGB565:
        draw_line_c2(pixels, w, h, x0, y0, x1, y1, draw_color, thickness);
        break;
    case IMAGE_FORMAT_RGB888:
                 ...
                 int fontsize)
{
    ...
    {
    case IMAGE_FORMAT_RGB565:
        draw_text_c2(pixels, w, h, text, x, y, fontsize, draw_color);
        break;
    case IMAGE_FORMAT_RGB888:
                 ...
                 int thickness)
{
    ...
    {
    case IMAGE_FORMAT_RGB565:
        draw_circle_c2(pixels, w, h, cx, cy, radius, draw_color, thickness);
        break;
    case IMAGE_FORMAT_RGB888:
...
void draw_image(image_buffer_t* image, unsigned char* draw_img, int x, int y, int rw, int rh)
{
    ...
    {
    case IMAGE_FORMAT_RGB565:
        draw_image_c2(pixels, w, h, draw_img, x, y, rw, rh);
        break;
    case IMAGE_FORMAT_RGB888:
